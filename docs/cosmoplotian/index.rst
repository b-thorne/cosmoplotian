...
the :any:`matplotlib` API. It does this in two main way:

* Provides a set of WCS projections using the :class:`astropy.visualization.wcsaxes.WCSAxes` 
  interface. These are designed to help plot :any:`HEALPix` maps in both Galactic and ICRS frames.
...
but mostly the package works behind the scenes in :any:`matplotlib`.
